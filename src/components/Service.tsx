...
const services = [
  {
    ...
    description: "Specialized one - on one exercises designed by a Physical therapist and corrective exercise specialist to overcome your mental fears",
    image: "/service-4.jpeg",
  },
  {
    title: "Therapy for Joint stiffness and muscle soreness",
    description: "Effective therapies to reduce joint stiffness and muscular tension for pain relief and improved mobility",
    image: "/service-3.jpeg",
  },
  {
    title: "Strength and conditioning for desk warriors",
    description: "Break free from your chairs and reclaim your bodies . Through our programs designed focusing on your specific problems like Low back pain, lack of energy",
          ...
          {services.map(({ title, description, image }) => (
            ...
            >
              <div className="relative aspect-video mb-4 rounded-xl overflow-hidden">
                <Image src={image} alt={title} fill className="object-cover hover:scale-105 transition" sizes="33vw" />
              </div>
