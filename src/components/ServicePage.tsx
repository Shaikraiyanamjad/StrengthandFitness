...
const services = [
  ...
  { title: "Personal Exercise design and training", desc: "Specialized one - on one exercises designed by a Physical therapist and corrective exercise specialist to overcome your mental fears.", img: "/service-3.jpeg" },
